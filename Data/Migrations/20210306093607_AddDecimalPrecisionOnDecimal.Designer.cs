...
namespace GestRehema.Data.Migrations
{
    ...
    [Migration("20210306093607_AddDecimalPrecisionOnDecimal")]
    partial class AddDecimalPrecisionOnDecimal
    {
            ...
            modelBuilder.Entity("GestRehema.Entities.Employee", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Prenom = "Rehema",
                            UserId = new Guid("0b75bb66-a0ef-4e56-bb8e-910b2fe0faa4")
                        });
                });
            ...
            modelBuilder.Entity("GestRehema.Entities.Entreprise", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2021, 3, 6, 9, 36, 1, 435, DateTimeKind.Utc).AddTicks(1817),
                            DateDuJour = new DateTime(2021, 3, 6, 9, 36, 1, 434, DateTimeKind.Utc).AddTicks(9217),
            ...
            modelBuilder.Entity("GestRehema.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("0b75bb66-a0ef-4e56-bb8e-910b2fe0faa4"),
                            AccessLevel = "all",
                            CreatedAt = new DateTime(2021, 3, 6, 9, 36, 1, 436, DateTimeKind.Utc).AddTicks(4104),
                            Password = "10000.7RDGz9IGfuZdhHeCl5u77A==.mXieT0ffCMXQTaKHZ51M7azT0nnvTOdwlS27ZBN/4lw=",
                            Role = "SuperAdmin",
            ...
            modelBuilder.Entity("GestRehema.Entities.Wallet", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AmountInExcess = 0m,
                            AmountOwned = 0m,
                            CreatedAt = new DateTime(2021, 3, 6, 9, 36, 1, 433, DateTimeKind.Utc).AddTicks(308)
                        });
                });
