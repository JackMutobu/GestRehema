...
namespace GestRehema.Data.Migrations
{
    ...
    [Migration("20210325090714_AddSupplierTypeToSupplierTable")]
    partial class AddSupplierTypeToSupplierTable
    {
            ...
            modelBuilder.Entity("GestRehema.Entities.Employee", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Prenom = "Rehema",
                            UserId = new Guid("f0ba19c8-a4c6-4e56-b93b-cfbfc45a41a4")
                        });
                });
            ...
            modelBuilder.Entity("GestRehema.Entities.Entreprise", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2021, 3, 25, 9, 7, 7, 7, DateTimeKind.Utc).AddTicks(9681),
                            DateDuJour = new DateTime(2021, 3, 25, 9, 7, 7, 7, DateTimeKind.Utc).AddTicks(7677),
            ...
            modelBuilder.Entity("GestRehema.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("f0ba19c8-a4c6-4e56-b93b-cfbfc45a41a4"),
                            AccessLevel = "all",
                            CreatedAt = new DateTime(2021, 3, 25, 9, 7, 7, 9, DateTimeKind.Utc).AddTicks(4996),
                            Password = "10000.hPcVN6YxHhspHnLYtq343w==.FUaVxNTfKaAYapjXzYvvcEhhqBg3PyosLlIn/eDC0Oc=",
                            Role = "SuperAdmin",
            ...
            modelBuilder.Entity("GestRehema.Entities.Wallet", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AmountInExcess = 0m,
                            AmountOwned = 0m,
                            CreatedAt = new DateTime(2021, 3, 25, 9, 7, 7, 5, DateTimeKind.Utc).AddTicks(5778)
                        });
                });
