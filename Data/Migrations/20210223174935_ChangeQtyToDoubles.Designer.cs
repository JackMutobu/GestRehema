...
namespace GestRehema.Data.Migrations
{
    ...
    [Migration("20210223174935_ChangeQtyToDoubles")]
    partial class ChangeQtyToDoubles
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GestRehema.Entities.Employee", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Prenom = "Rehema",
                            UserId = new Guid("d9a91617-d12b-49da-b7d1-cfdd2cbdf98a")
                        });
                });
            ...
            modelBuilder.Entity("GestRehema.Entities.Entreprise", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = -1,
                            CreatedAt = new DateTime(2021, 2, 23, 17, 49, 28, 731, DateTimeKind.Utc).AddTicks(7626),
                            DateDuJour = new DateTime(2021, 2, 23, 17, 49, 28, 731, DateTimeKind.Utc).AddTicks(5644),
            ...
            modelBuilder.Entity("GestRehema.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("d9a91617-d12b-49da-b7d1-cfdd2cbdf98a"),
                            AccessLevel = "all",
                            CreatedAt = new DateTime(2021, 2, 23, 17, 49, 28, 732, DateTimeKind.Utc).AddTicks(7203),
                            Password = "10000.BCiqaT+NC8f1h61YoITyFQ==.4MENaOFE1atw2Xma5iRorSAoJKnNDeExAEEw1bB64Rs=",
                            Role = "SuperAdmin",
            ...
            modelBuilder.Entity("GestRehema.Entities.Wallet", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = -1,
                            Balance = 0m,
                            CreatedAt = new DateTime(2021, 2, 23, 17, 49, 28, 730, DateTimeKind.Utc).AddTicks(840)
                        });
                });
            ...
            modelBuilder.Entity("GestRehema.Entities.WalletHistory", b =>
                {
                    ...
                    b.Property<int?>("AmountInWalletId")
                        .HasColumnType("int");

                    b.Property<decimal>("AmountOut")
                        .HasColumnType("decimal(18,2)");

                    b.Property<int?>("AmountOutWalletId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("AmountInWalletId");

                    b.HasIndex("AmountOutWalletId");
            ...
            modelBuilder.Entity("GestRehema.Entities.WalletHistory", b =>
                {
                    b.HasOne("GestRehema.Entities.Wallet", "AmountInWallet")
                        .WithMany()
                        .HasForeignKey("AmountInWalletId");

                    b.HasOne("GestRehema.Entities.Wallet", "AmountOutWallet")
                        .WithMany()
                        .HasForeignKey("AmountOutWalletId");

                    b.Navigation("AmountInWallet");

                    b.Navigation("AmountOutWallet");
                });
