...
namespace GestRehema.Data.Migrations
{
    ...
    [Migration("20210224140159_UpdateEntreprise")]
            ...
            modelBuilder.Entity("GestRehema.Entities.Employee", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Prenom = "Rehema",
                            UserId = new Guid("79f49352-53f3-4c81-9f46-348aba02a6db")
                        });
                });
            ...
            modelBuilder.Entity("GestRehema.Entities.Entreprise", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2021, 2, 24, 14, 1, 53, 767, DateTimeKind.Utc).AddTicks(8657),
                            DateDuJour = new DateTime(2021, 2, 24, 14, 1, 53, 767, DateTimeKind.Utc).AddTicks(6613),
            ...
            modelBuilder.Entity("GestRehema.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("79f49352-53f3-4c81-9f46-348aba02a6db"),
                            AccessLevel = "all",
                            CreatedAt = new DateTime(2021, 2, 24, 14, 1, 53, 769, DateTimeKind.Utc).AddTicks(2049),
                            Password = "10000.eaaa6w4uNCr0TlKOykfF6w==.jVf2V1FyRKArmc/tX1Q5EmA+QfjRI2m9RvieTN5+bM0=",
                            Role = "SuperAdmin",
            ...
            modelBuilder.Entity("GestRehema.Entities.Wallet", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AmountInExcess = 0m,
                            AmountOwned = 0m,
                            CreatedAt = new DateTime(2021, 2, 24, 14, 1, 53, 765, DateTimeKind.Utc).AddTicks(5094)
                        });
                });
