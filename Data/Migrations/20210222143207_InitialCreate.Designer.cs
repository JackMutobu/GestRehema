...
namespace GestRehema.Data.Migrations
{
    ...
    [Migration("20210222143207_InitialCreate")]
            ...
            modelBuilder.Entity("GestRehema.Entities.Employee", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Prenom = "Rehema",
                            UserId = new Guid("2e743d90-e166-4e6f-9547-49fee5078f5b")
                        });
                });
            ...
            modelBuilder.Entity("GestRehema.Entities.Entreprise", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = -1,
                            CreatedAt = new DateTime(2021, 2, 22, 14, 32, 3, 457, DateTimeKind.Utc).AddTicks(8245),
                            DateDuJour = new DateTime(2021, 2, 22, 14, 32, 3, 457, DateTimeKind.Utc).AddTicks(6299),
            ...
            modelBuilder.Entity("GestRehema.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("2e743d90-e166-4e6f-9547-49fee5078f5b"),
                            AccessLevel = "all",
                            CreatedAt = new DateTime(2021, 2, 22, 14, 32, 3, 458, DateTimeKind.Utc).AddTicks(7935),
                            Password = "10000.VEaG4Re9I8Z3HaB0T9niAQ==.TMhfWSLWX63Kbv6EndPUSX2rk9Sj5mGeBOk13kCphWM=",
                            Role = "SuperAdmin",
            ...
            modelBuilder.Entity("GestRehema.Entities.Wallet", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = -1,
                            Balance = 0m,
                            CreatedAt = new DateTime(2021, 2, 22, 14, 32, 3, 456, DateTimeKind.Utc).AddTicks(1979)
                        });
                });
