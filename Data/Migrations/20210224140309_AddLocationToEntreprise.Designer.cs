...
namespace GestRehema.Data.Migrations
{
    ...
    [Migration("20210224140309_AddLocationToEntreprise")]
    partial class AddLocationToEntreprise
    {
            ...
            modelBuilder.Entity("GestRehema.Entities.Employee", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Prenom = "Rehema",
                            UserId = new Guid("f14162fb-6335-4175-8f9c-da4399cf02e0")
                        });
                });
            ...
            modelBuilder.Entity("GestRehema.Entities.Entreprise", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2021, 2, 24, 14, 3, 6, 626, DateTimeKind.Utc).AddTicks(3508),
                            DateDuJour = new DateTime(2021, 2, 24, 14, 3, 6, 626, DateTimeKind.Utc).AddTicks(527),
            ...
            modelBuilder.Entity("GestRehema.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("f14162fb-6335-4175-8f9c-da4399cf02e0"),
                            AccessLevel = "all",
                            CreatedAt = new DateTime(2021, 2, 24, 14, 3, 6, 628, DateTimeKind.Utc).AddTicks(2508),
                            Password = "10000.g9nesA5UCKiewpBHWp1R+Q==.Rxcv964BSbvuSVwZOKvQhifa5L6VPdCKFkcpDV5gKok=",
                            Role = "SuperAdmin",
            ...
            modelBuilder.Entity("GestRehema.Entities.Wallet", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AmountInExcess = 0m,
                            AmountOwned = 0m,
                            CreatedAt = new DateTime(2021, 2, 24, 14, 3, 6, 623, DateTimeKind.Utc).AddTicks(7500)
                        });
                });
